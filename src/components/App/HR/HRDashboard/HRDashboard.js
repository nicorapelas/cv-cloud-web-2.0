...
const HRDashboard = () => {
  ...
  const fetchSavedCVs = async () => {
    try {
      setLoading(true);
      const response = await api.get('/hr/saved-cv/');
        ...
        <div className="hr-dashboard-header-content">
          ...
          <div className="hr-dashboard-user-info">
            ...
            <div className="hr-dashboard-header-actions">
              <Link to="/app/dashboard" className="hr-dashboard-switch-button">
                Dashboard
              </Link>
              <button onClick={handleSignout} className="hr-dashboard-signout">
                Sign Out
              </button>
            </div>
          </div>
      ...
      <main className="hr-dashboard-main">
        <div className="hr-dashboard-container">
          ...
          <section className="hr-dashboard-stats">
            ...
            <div className="hr-dashboard-stat">
              <span className="hr-dashboard-stat-number">
                {savedCVs.reduce((total, cv) => total + (cv.viewCount || 0), 0)}
              </span>
                    ...
                    <div className="hr-dashboard-cv-actions">
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          console.log('Edit notes for:', cv.curriculumVitaeID);
                        }}
                      >
                        Add Notes
                      </button>
